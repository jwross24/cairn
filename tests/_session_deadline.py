...
# so a run under load average 6-9 (2053 s, 2026-09-03) finishes inside it; CI sets 1080 through
...
# and far inside the gap between CI's 1080 s deadline and its 20-minute job ceiling.
BACKSTOP_GRACE = 15
JOIN_TIMEOUT_S = 5
