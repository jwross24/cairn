...
```bash
mkdir -p ~/Documents/cairn/research/convergence/r3/seats
bun ~/.claude/scripts/multi-model.ts review --doc ~/Documents/cairn/research/convergence/plan-r2.md --prompt-file ~/Documents/cairn/research/convergence/review-prompt.md --out ~/Documents/cairn/research/convergence/r3/seats --max-tokens 10000 --json > ~/Documents/cairn/research/convergence/r3/seats.json 2> ~/Documents/cairn/research/convergence/r3/seats.log
```
